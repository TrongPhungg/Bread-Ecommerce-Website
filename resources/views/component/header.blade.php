            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="{{ route('trangchu') }}" class="navbar-brand">
                        <h1 class="text-primary display-6">PhongHien's Bakery</h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            <div class="position-relative me-4 my-auto">
                                ...
                                <div class="cart-items cart-hover-content position-absolute bg-white shadow p-3" style="width: 300px; right: 0; top: 100%; display: none; z-index: 1000; border-radius: 20px;">
                                    <div class="cart-item d-flex align-items-center mb-3" id="cart-item">
                            ...
                            <style>
                                ...
                                @media (min-width: 577px) and (max-width: 768px) {
                                    .cart-hover-content {
                                        ...
                                        /* Dùng absolute để định vị tương đối với phần tử cha */
                                        top: 0 !important;
                                        /* Đưa nội dung lên phía trên giỏ hàng */
                                        bottom: auto !important;
                                        /* Không hiển thị ở dưới */
                                        border-radius: 20px 20px 0 0 !important;
                                        /* Góc bo nằm ở phía trên */
                                    }
                                }
